...
static void InitDefaultsscc_info_Ins_ins_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::crdc::airi::_Ins_default_instance_;
    new (ptr) ::crdc::airi::Ins();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3> scc_info_Ins_ins_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 3, 0, InitDefaultsscc_info_Ins_ins_2eproto}, {
      &scc_info_Header_header_2eproto.base,
      &scc_info_PointLLH_geometry_2eproto.base,
      &scc_info_Point3D_geometry_2eproto.base,}};

static void InitDefaultsscc_info_InsStat_ins_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::crdc::airi::_InsStat_default_instance_;
    new (ptr) ::crdc::airi::InsStat();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_InsStat_ins_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_InsStat_ins_2eproto}, {
      &scc_info_Header_header_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_ins_2eproto[2];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_ins_2eproto[1];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_ins_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::crdc::airi::InsStat, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::InsStat, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::crdc::airi::InsStat, header_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::InsStat, ins_status_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::InsStat, pos_type_),
  0,
  1,
  2,
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, header_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, measurement_time_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, type_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, position_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, euler_angles_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, linear_velocity_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, angular_velocity_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, linear_acceleration_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, position_covariance_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, euler_angles_covariance_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, linear_velocity_covariance_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, angular_velocity_covariance_),
  PROTOBUF_FIELD_OFFSET(::crdc::airi::Ins, linear_acceleration_covariance_),
  0,
  6,
  7,
  1,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 8, sizeof(::crdc::airi::InsStat)},
  { 11, 29, sizeof(::crdc::airi::Ins)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::crdc::airi::_InsStat_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::crdc::airi::_Ins_default_instance_),
};

const char descriptor_table_protodef_ins_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\tins.proto\022\tcrdc.airi\032\014header.proto\032\016ge"
  "ometry.proto\"R\n\007InsStat\022!\n\006header\030\001 \001(\0132"
  "\021.crdc.airi.Header\022\022\n\nins_status\030\002 \001(\r\022\020"
  "\n\010pos_type\030\003 \001(\r\"\264\004\n\003Ins\022!\n\006header\030\001 \001(\013"
  "2\021.crdc.airi.Header\022\030\n\020measurement_time\030"
  "\002 \001(\001\022!\n\004type\030\003 \001(\0162\023.crdc.airi.Ins.Type"
  "\022%\n\010position\030\004 \001(\0132\023.crdc.airi.PointLLH\022"
  "(\n\014euler_angles\030\005 \001(\0132\022.crdc.airi.Point3"
  "D\022+\n\017linear_velocity\030\006 \001(\0132\022.crdc.airi.P"
  "oint3D\022,\n\020angular_velocity\030\007 \001(\0132\022.crdc."
  "airi.Point3D\022/\n\023linear_acceleration\030\010 \001("
  "\0132\022.crdc.airi.Point3D\022\037\n\023position_covari"
  "ance\030\t \003(\002B\002\020\001\022#\n\027euler_angles_covarianc"
  "e\030\n \003(\002B\002\020\001\022&\n\032linear_velocity_covarianc"
  "e\030\013 \003(\002B\002\020\001\022\'\n\033angular_velocity_covarian"
  "ce\030\014 \003(\002B\002\020\001\022*\n\036linear_acceleration_cova"
  "riance\030\r \003(\002B\002\020\001\"-\n\004Type\022\013\n\007INVALID\020\000\022\016\n"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_ins_2eproto_sccs[2] = {
  &scc_info_Ins_ins_2eproto.base,
  &scc_info_InsStat_ins_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ins_2eproto = {
  false, false, descriptor_table_protodef_ins_2eproto, "ins.proto", 703,
  &descriptor_table_ins_2eproto_once, descriptor_table_ins_2eproto_sccs, descriptor_table_ins_2eproto_deps, 2, 2,
  schemas, file_default_instances, TableStruct_ins_2eproto::offsets,
  file_level_metadata_ins_2eproto, 2, file_level_enum_descriptors_ins_2eproto, file_level_service_descriptors_ins_2eproto,
};
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Ins_Type_descriptor() {
  ...
  return file_level_enum_descriptors_ins_2eproto[0];
}
...
class InsStat::_Internal {
 public:
  ...
  static const ::crdc::airi::Header& header(const InsStat* msg);
...
InsStat::InsStat(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:crdc.airi.InsStat)
}
InsStat::InsStat(const InsStat& from)
  ...
  // @@protoc_insertion_point(copy_constructor:crdc.airi.InsStat)
}

void InsStat::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_InsStat_ins_2eproto.base);
...
InsStat::~InsStat() {
  // @@protoc_insertion_point(destructor:crdc.airi.InsStat)
  SharedDtor();
...
void InsStat::Clear() {
// @@protoc_insertion_point(message_clear_start:crdc.airi.InsStat)
...
::PROTOBUF_NAMESPACE_ID::uint8* InsStat::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:crdc.airi.InsStat)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:crdc.airi.InsStat)
  return target;
}

size_t InsStat::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:crdc.airi.InsStat)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:crdc.airi.InsStat)
  GOOGLE_DCHECK_NE(&from, this);
  const InsStat* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<InsStat>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:crdc.airi.InsStat)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:crdc.airi.InsStat)
    MergeFrom(*source);
  }
}

void InsStat::MergeFrom(const InsStat& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:crdc.airi.InsStat)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:crdc.airi.InsStat)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:crdc.airi.InsStat)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class Ins::_Internal {
 public:
  ...
  static const ::crdc::airi::Header& header(const Ins* msg);
  static void set_has_header(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  ...
  static const ::crdc::airi::PointLLH& position(const Ins* msg);
  static void set_has_position(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
  static const ::crdc::airi::Point3D& euler_angles(const Ins* msg);
  static void set_has_euler_angles(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
  static const ::crdc::airi::Point3D& linear_velocity(const Ins* msg);
  static void set_has_linear_velocity(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
  static const ::crdc::airi::Point3D& angular_velocity(const Ins* msg);
  static void set_has_angular_velocity(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
  static const ::crdc::airi::Point3D& linear_acceleration(const Ins* msg);
...
Ins::Ins(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:crdc.airi.Ins)
}
Ins::Ins(const Ins& from)
  ...
  // @@protoc_insertion_point(copy_constructor:crdc.airi.Ins)
}

void Ins::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Ins_ins_2eproto.base);
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      reinterpret_cast<char*>(&header_) - reinterpret_cast<char*>(this)),
...
Ins::~Ins() {
  // @@protoc_insertion_point(destructor:crdc.airi.Ins)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
void Ins::Clear() {
// @@protoc_insertion_point(message_clear_start:crdc.airi.Ins)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ...
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::crdc::airi::Ins_Type_IsValid(val))) {
            _internal_set_type(static_cast<::crdc::airi::Ins_Type>(val));
          } else {
...
::PROTOBUF_NAMESPACE_ID::uint8* Ins::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:crdc.airi.Ins)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:crdc.airi.Ins)
  return target;
}

size_t Ins::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:crdc.airi.Ins)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:crdc.airi.Ins)
  GOOGLE_DCHECK_NE(&from, this);
  const Ins* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Ins>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:crdc.airi.Ins)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:crdc.airi.Ins)
    MergeFrom(*source);
  }
}

void Ins::MergeFrom(const Ins& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:crdc.airi.Ins)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:crdc.airi.Ins)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:crdc.airi.Ins)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::crdc::airi::InsStat* Arena::CreateMaybeMessage< ::crdc::airi::InsStat >(Arena* arena) {
  return Arena::CreateMessageInternal< ::crdc::airi::InsStat >(arena);
}
template<> PROTOBUF_NOINLINE ::crdc::airi::Ins* Arena::CreateMaybeMessage< ::crdc::airi::Ins >(Arena* arena) {
  return Arena::CreateMessageInternal< ::crdc::airi::Ins >(arena);
}
