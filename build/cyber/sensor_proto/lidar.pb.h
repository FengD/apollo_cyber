...
class PointClouds PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  int _internal_cloud_size() const;
  public:
  void clear_cloud();
  ::crdc::airi::PointCloud* mutable_cloud(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::crdc::airi::PointCloud >*
      mutable_cloud();
  private:
  const ::crdc::airi::PointCloud& _internal_cloud(int index) const;
  ::crdc::airi::PointCloud* _internal_add_cloud();
  public:
  const ::crdc::airi::PointCloud& cloud(int index) const;
  ::crdc::airi::PointCloud* add_cloud();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::crdc::airi::PointCloud > cloud_;
  ::crdc::airi::Header* header_;
  friend struct ::TableStruct_lidar_2eproto;
};
// ===================================================================
...
inline const std::string& PointCloud::frame_id() const {
  // @@protoc_insertion_point(field_get:crdc.airi.PointCloud.frame_id)
  return _internal_frame_id();
}
inline void PointCloud::set_frame_id(const std::string& value) {
  _internal_set_frame_id(value);
  // @@protoc_insertion_point(field_set:crdc.airi.PointCloud.frame_id)
}
inline std::string* PointCloud::mutable_frame_id() {
  // @@protoc_insertion_point(field_mutable:crdc.airi.PointCloud.frame_id)
...
inline void PointCloud::set_frame_id(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:crdc.airi.PointCloud.frame_id)
}
inline void PointCloud::set_frame_id(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:crdc.airi.PointCloud.frame_id)
}
inline void PointCloud::set_frame_id(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:crdc.airi.PointCloud.frame_id)
}
...
inline std::string* PointCloud::release_frame_id() {
  // @@protoc_insertion_point(field_release:crdc.airi.PointCloud.frame_id)
...
inline void PointCloud::set_allocated_frame_id(std::string* frame_id) {
  ...
  frame_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), frame_id,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:crdc.airi.PointCloud.frame_id)
}
...
// repeated .crdc.airi.PointCloud cloud = 2;
inline int PointClouds::_internal_cloud_size() const {
  return cloud_.size();
}
inline int PointClouds::cloud_size() const {
  return _internal_cloud_size();
}
inline void PointClouds::clear_cloud() {
  cloud_.Clear();
}
inline ::crdc::airi::PointCloud* PointClouds::mutable_cloud(int index) {
  // @@protoc_insertion_point(field_mutable:crdc.airi.PointClouds.cloud)
  return cloud_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::crdc::airi::PointCloud >*
PointClouds::mutable_cloud() {
  // @@protoc_insertion_point(field_mutable_list:crdc.airi.PointClouds.cloud)
  return &cloud_;
}
inline const ::crdc::airi::PointCloud& PointClouds::_internal_cloud(int index) const {
  return cloud_.Get(index);
}
inline const ::crdc::airi::PointCloud& PointClouds::cloud(int index) const {
  // @@protoc_insertion_point(field_get:crdc.airi.PointClouds.cloud)
  return _internal_cloud(index);
}
inline ::crdc::airi::PointCloud* PointClouds::_internal_add_cloud() {
  return cloud_.Add();
}
inline ::crdc::airi::PointCloud* PointClouds::add_cloud() {
  // @@protoc_insertion_point(field_add:crdc.airi.PointClouds.cloud)
  return _internal_add_cloud();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::crdc::airi::PointCloud >&
PointClouds::cloud() const {
  // @@protoc_insertion_point(field_list:crdc.airi.PointClouds.cloud)
  return cloud_;
}
